...
# Manual task management workflow — invoke directly to transition a task's status.
# (`/evolve`, once mentioned here, was removed from the command surface; see
# .plaesy/memory/command-surface.md. /continue and /implement manage most task
# transitions inline — use this script for manual/ad-hoc moves.)
