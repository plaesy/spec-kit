...
show-platform-info() {
    ...
    local name provider category
    name=$(get-platform-config "$platform" "name")
    provider=$(get-platform-config "$platform" "provider")
    category=$(get-platform-config "$platform" "category")
