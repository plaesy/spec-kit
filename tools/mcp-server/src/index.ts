...
class SpecKitMCPServer {
    ...
    private framework: ConstitutionalFramework;
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            switch (name) {
                case 'detect_and_load_context':
                    return await this.contextDetector.detectAndLoadContext(args as any);

                case 'switch_agent_persona':
                    return await this.agentOrchestrator.switchPersona(args as any);

                case 'validate_constitutional_compliance':
                    return await this.framework.validateCompliance(args as any);
