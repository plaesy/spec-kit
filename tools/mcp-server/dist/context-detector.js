...
export class ContextDetector {
    ...
    async detectAndLoadContext(args) {
    ...
    analyzeContent(content, explicitDomains) {
    ...
    detectDomains(content, explicitDomains) {
    ...
    mapTechnologiesToInstructions(technologies) {
        const techToInstructions = {
    ...
    calculateConfidence(technologies, domains) {
    ...
    async generateRecommendations(detection) {
        return {
    ...
    getConstitutionalDomains(domains) {
    ...
    getWorkflowSuggestions(detection) {
        const suggestions = [];
