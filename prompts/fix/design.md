---
description: "WCAG violations, token inconsistencies"
---

# `/fix:design` command instructions

This is the **design**-scoped entry point into `/fix`. Follow the full protocol
defined in `/fix`, with scope fixed to **design**: WCAG violations, token inconsistencies.
