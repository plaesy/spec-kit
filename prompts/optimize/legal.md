---
description: "Clause traceability, compliance"
---

# `/optimize:legal` command instructions

This is the **legal**-scoped entry point into `/optimize`. Follow the full protocol
defined in `/optimize`, with scope fixed to **legal**: Clause traceability, compliance.
