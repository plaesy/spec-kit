...
is what `/implement`, `/continue`, and `/save` actually read and write.
...
- [chatmode.template.md](chatmode.template.md) — scaffold for authoring a new `chatmodes/*.chatmode.md` role
