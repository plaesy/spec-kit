...
<details>
<summary><strong>🎬 Click to see 3-minute demo: From idea to production</strong></summary>

```bash
# 1. Initialize with your preferred AI assistant
plaesy init demo-app --ai copilot

# 2. Create project structure following constitutional principles
cd demo-app

# 3. Load constitutional framework in AI assistant
# Load .plaesy/chatmodes/dev.chatmode.md

# 4. Start with TDD approach:
# "Help me implement photo import feature with TDD"
# "Create tests for file validation first"
# "Add security checks for uploaded files"

# 5. Validate constitutional compliance
npm run test:tdd          # Run TDD validation
npm run security         # Security audit  
npm run coverage         # Check 85%+ coverage

# Result: Constitutional development active!
...
**Problem: Constitutional validation failures**
```bash
