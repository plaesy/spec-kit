...
- /start → /assess (research mode): Technology validation
- /assess (research mode, Design Spine, if UI): Tech decisions → design specs
- /assess (research mode) → /implement: Tech validated → ready to build
- /assess (Design Spine) → /implement: Design specs → component API
- /implement → /assess: Code → quality measurement
- /assess → /assess (research mode, loop): Assessment findings → validate solutions
