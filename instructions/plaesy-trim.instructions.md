...
.plaesy/scripts/powershell/plaesy-trim.ps1 llm-queue -Path .plaesy/instructions/plaesy.md   # export prose to rewrite
.plaesy/scripts/powershell/plaesy-trim.ps1 apply-llm -Path .plaesy/instructions/plaesy.md -Annotations ann.json  # merge back
...
.plaesy/scripts/bash/plaesy-trim.sh compress --path .plaesy/instructions/plaesy.md
...
.plaesy/scripts/bash/plaesy-trim.sh llm-queue --path .plaesy/instructions/plaesy.md
.plaesy/scripts/bash/plaesy-trim.sh apply-llm --path .plaesy/instructions/plaesy.md --annotations ann.json
