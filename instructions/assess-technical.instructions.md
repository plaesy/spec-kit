...
**Reference checklists**: `.plaesy/checklists/sa.checklist.md` (architecture, tech
choices, security, performance) and `.plaesy/checklists/qa.checklist.md` (quality
gates, testing, sign-off) — use alongside this file's scoring dimensions.
...
1. **Confidence Levels**:
   - HIGH: Based on actual code review + test results + metrics
   - MEDIUM: Based on pattern detection + file inspection
...
4. **Speculative vs Confirmed**:
   - CONFIRMED: [Based on specific code evidence]
   - LIKELY: [Pattern matches, but unconfirmed]
...
- **If design quality score <80 (UI projects)** → Load `.plaesy/instructions/assess-design.md`
